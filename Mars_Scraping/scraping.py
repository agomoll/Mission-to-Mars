...
def scrape_all():
    # Set up executable path and headless browser
...
def mars_facts():
    ...
    # Convert DataFrame back to html for the web app, add bootstrap
...
def hemisphere(browser):
    ...
    images = browser.find_by_css("a.product-item")
    #print(images)
    ...
    for image in range(len(images)):
        ...
        browser.find_by_css("a.product-item")[image].click()
